...
- **Global Consensus:** The highest-scoring word found by _any_ player becomes the permanent play on the board for the next day.
...
_(See [rules](./RULES.md) for details)_
